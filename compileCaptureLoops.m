...
for tr = 1:1%length(head); % trials(example)%44 is the start of the newly added Ear plug videos
...
%     plot(pl,'m');
    ...
    %% 
    figure
    bar(PreAppCkMu(1,1:4)); hold on; errorbar(1:4,PreAppCkMu(1,1:4),errPreAppCk(1,1:4),'o')
