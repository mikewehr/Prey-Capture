function AnalyzeDeepCutTrackingData(datapath, start_frame, stop_frame, analysis_plots_dir)
...
out=LoadDeepCutTracks(datapath);
...
if isempty(stop_frame)
    stop_frame=min(length(out.mouseCOMxy), length(out.cricketxy)); %to use whole video
end
